...
/*! @brief Opaque window Instance.
 *
 *  Opaque window Instance.
 *
...
/*! @brief Opaque cursor Instance.
 *
 *  Opaque cursor Instance.
 *
 ...
 *
 *  @param[in] cursor The cursor Instance to destroy.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 *
